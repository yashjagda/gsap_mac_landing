...
Files: macbook-14.glb [629.72KB] > /Users/yj/Project/MbPro/macbook-pro-clone/public/models/macbook-14-transformed.glb [627.9KB] (0%)
...
export default function MacbookModel14(props) {
  ...
  //used to apply color change on mac model
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        //change only if its in noChangeParts
